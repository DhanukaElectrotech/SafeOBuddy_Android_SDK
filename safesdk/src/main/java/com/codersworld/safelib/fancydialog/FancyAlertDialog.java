...
public class FancyAlertDialog {
    ...
    private Boolean nBtnVisible = false;
    ...
    private FancyAlertDialog(Builder builder) {
        ...
        this.nBtnVisible = builder.nBtnVisible;
    ...
    public static class Builder {
        ...
        public Builder hideNegatibeBtn(Boolean isTrue) {
            this.nBtnVisible = isTrue;
            return this;
        }
    ...
    public static void showErrorDiloag(Context mContext, String msg, String title, String positiveBtnText) {
        Builder.with(mContext)
                ...
                .hideNegatibeBtn(true)
                .setBackgroundColor(mContext.getResources().getColor(R.color.color_red))
                .setIcon(R.drawable.ic_clear_black_24dp, View.VISIBLE)
                .onPositiveClicked(dialog -> dialog.dismiss())
                .build()
                .show();
    }
    // endregion
